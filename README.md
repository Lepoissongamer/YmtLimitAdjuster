...
- **Alexander Blade — ASI loading environment:** [Script Hook V and its ASI Loader](https://www.dev-c.com/gtav/scripthookv/). The plugin is compatible with this loader without calling Script Hook V natives.
...
The plugin is an independent implementation; no FiveM runtime is included. Attribution and licensing information for bundled third-party components is provided in [THIRD_PARTY_NOTICES.md](THIRD_PARTY_NOTICES.md).
